...
-- -----------------------------------------------------
-- Table `gestorDatabase`.`users_has_parents`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestorDatabase`.`users_has_parents`
(
    `users_has_parentsId` INT NOT NULL AUTO_INCREMENT,
    `users_userId`        INT NOT NULL,
    `users_parentId`      INT NOT NULL,
    PRIMARY KEY (`users_has_parentsId`),
    INDEX `fk_parents_users2_idx` (`users_userId` ASC) VISIBLE,
    UNIQUE INDEX `parentsId_UNIQUE` (`users_has_parentsId` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Data for table `gestorDatabase`.`users_has_parents`
-- -----------------------------------------------------
START TRANSACTION;
USE `gestorDatabase`;
INSERT INTO `gestorDatabase`.`users_has_parents` (`users_has_parentsId`, `users_userId`, `users_parentId`)
VALUES (1, 1, 4);
INSERT INTO `gestorDatabase`.`users_has_parents` (`users_has_parentsId`, `users_userId`, `users_parentId`)
VALUES (2, 2, 3);
