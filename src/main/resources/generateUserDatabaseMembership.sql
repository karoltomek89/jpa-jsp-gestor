...
(
    ...
    PRIMARY KEY (`subjects_subjectId`),
...
(
    `parentsId`      INT NOT NULL AUTO_INCREMENT,
    `users_userId`   INT NOT NULL,
    `users_parentId` INT NOT NULL,
    PRIMARY KEY (`parentsId`),
    INDEX `fk_parents_users2_idx` (`users_userId` ASC) VISIBLE,
    UNIQUE INDEX `parentsId_UNIQUE` (`parentsId` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `gestorDatabase`.`classes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestorDatabase`.`classes`
(
...
-- -----------------------------------------------------
-- Table `gestorDatabase`.`classes_has_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestorDatabase`.`classes_has_users`
(
    `classes_classId` INT NOT NULL,
    `users_userId`    INT NOT NULL,
    PRIMARY KEY (`classes_classId`),
    INDEX `fk_classes_has_users_users1_idx` (`users_userId` ASC) VISIBLE,
    INDEX `fk_classes_has_users_classes1_idx` (`classes_classId` ASC) VISIBLE,
    CONSTRAINT `fk_classes_has_users_classes1`
        FOREIGN KEY (`classes_classId`)
            REFERENCES `gestorDatabase`.`classes` (`classId`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
...
INSERT INTO `gestorDatabase`.`membership` (`membershipId`, `type`, `comment`)
VALUES (2, 'user', 'can send messages, add grades');
INSERT INTO `gestorDatabase`.`membership` (`membershipId`, `type`, `comment`)
VALUES (3, 'parent', 'can see student\'s grades, messages and homeworks');
INSERT INTO `gestorDatabase`.`membership` (`membershipId`, `type`, `comment`)
...
START TRANSACTION;
USE `gestorDatabase`;
INSERT INTO `gestorDatabase`.`parents` (`parentsId`, `users_userId`, `users_parentId`)
VALUES (1, 1, 4);
INSERT INTO `gestorDatabase`.`parents` (`parentsId`, `users_userId`, `users_parentId`)
VALUES (2, 2, 3);
...
-- -----------------------------------------------------
-- Data for table `gestorDatabase`.`classes`
-- -----------------------------------------------------
START TRANSACTION;
USE `gestorDatabase`;
INSERT INTO `gestorDatabase`.`classes` (`classId`, `name`)
VALUES (1, 'VII');
INSERT INTO `gestorDatabase`.`classes` (`classId`, `name`)
VALUES (2, 'VIII');
...
-- -----------------------------------------------------
-- Data for table `gestorDatabase`.`classes_has_users`
-- -----------------------------------------------------
START TRANSACTION;
USE `gestorDatabase`;
INSERT INTO `gestorDatabase`.`classes_has_users` (`classes_classId`, `users_userId`)
VALUES (1, 1);
INSERT INTO `gestorDatabase`.`classes_has_users` (`classes_classId`, `users_userId`)
VALUES (2, 2);
